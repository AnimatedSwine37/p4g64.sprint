...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[Sprint] {message}");
    }
    ...
    {
        _logger.WriteLine($"[Sprint] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[Sprint] {message}", System.Drawing.Color.Red);
    }
